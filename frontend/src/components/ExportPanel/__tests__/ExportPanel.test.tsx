...
describe('ExportPanel', () => {
  ...
  it('renders passing conformance summary with unknown engine fallback', () => {
    render(
      <ExportPanel
        {...baseProps}
        conformanceResult={{
    ...
    expect(screen.getByText('✓ AAS conformance check passed')).toBeInTheDocument();
    expect(screen.getByText(/Engine: unknown \| Duration: 9ms/)).toBeInTheDocument();
  });
